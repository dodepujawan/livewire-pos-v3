<div class="h-screen p-3 overflow-hidden">
    <div class="flex items-center justify-between mb-2">
        <div>
            <h1 class="text-lg font-bold">Buat Pembelian</h1>
        </div>
    ...
    <form wire:submit.prevent="savePembelian" class="h-[calc(100vh-60px)]">
        <div class="grid gap-2 h-full min-h-0" style="grid-template-columns: 300px minmax(0,1fr) 300px;">
                ...
                <div class="bg-white rounded shadow p-3 shrink-0">
                    <div class="space-y-2">
                        <div>
                            ...
                            <input type="text" wire:model="pembelianNo" readonly class="w-full border rounded px-3 py-1.5 bg-gray-100 text-sm">
                            @error('pembelianNo')
                        ...
                        <div>
                            ...
                            <input type="date" wire:model="pembelianTanggal" class="w-full border rounded px-3 py-1.5 text-sm">
                        ...
                        <div>
                            ...
                            <select wire:model="pembelianCabangId" class="w-full border rounded px-3 py-1.5 text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="pembelianSupplier" class="w-full border rounded px-3 py-1.5 text-sm" placeholder="Nama supplier">
            ...
            <div class="flex flex-col gap-2 min-h-0 overflow-y-auto pl-1">
                ...
                <div class="flex flex-col gap-2 shrink-0">
                    <button type="submit" class="w-full px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 font-semibold text-xs">Simpan Pembelian</button>
