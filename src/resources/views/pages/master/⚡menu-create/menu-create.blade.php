<x-form.card>
    ...
    <div class="space-y-6">
                    ...
                    <div class="sm:col-span-2">
                        <div class="flex items-end gap-2">
                            <div class="flex-1">
                                ...
                                >
                                    <option value="">Create Root Menu (No Parent)</option>
        ...
        <div class="flex justify-end gap-3">
            <a href="{{ route('master.menu.list') }}" wire:navigate class="inline-flex items-center rounded-lg border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50">
                Cancel
            </a>
